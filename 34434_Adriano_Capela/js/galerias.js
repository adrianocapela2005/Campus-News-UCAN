...
//Animacoes scroll
const imagens = document.querySelectorAll('.grade-album img');
imagens.forEach(el => el.classList.add('fade-in-up'));
...
imagens.forEach(el => observer.observe(el));
...
console.log('Página de galeria carregada com sucesso!');